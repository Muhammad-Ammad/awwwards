...
const Hero = () => {
    ...
    const getVideoSrc = (index: any) => {
        ...
        return index === 4 ? videoArray[0] : videoArray[index];
    };
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75" >
                ...
                <div className="absolute left-0 top-0 z-40 size-full" >
                    <div className="mt-24 px-5 sm:px-10" >
                        ...
                        <p className="mb-5 max-w-64 font-robert-regular text-blue-100" >Enter the Megagame Layer<br />Unleash the Play Economy </p>
                        <Button id={"watch-trailer"} title={"Watch Trailer"} leftIcon={<TiLocationArrow />} containerClass={"!bg-yellow-300 flex flex-center gap-1"} />
                    </div>
                </div>
            </div>
